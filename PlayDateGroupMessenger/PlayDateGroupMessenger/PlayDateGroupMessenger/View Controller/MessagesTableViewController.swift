...
class MessagesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
         ...
         assignTableViewBackgroundImage()
...
//        observeMessages()
    ...
    func assignTableViewBackgroundImage() {
  
        tableView.backgroundView = UIImageView(image: UIImage(named: "tableViewControllerImage"))
...
// FIXME: this line below was commented out - it was handling other features in the setUpNavBarWithUsers
//                                self.navigationItem.title = dictionary["name"] as? String
    ...
    func setupNavBarWithUser(_ user: User) {
        ...
        nameLabel.font = UIFont.init(name: "noteworthy", size: 20)
